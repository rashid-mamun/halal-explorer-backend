...
router.post('/book', cruiseController.cruiseBook);
router.get('/book/all', cruiseController.getAllBookings);
router.get('/book/:email', cruiseController.getBookingsByEmail);
